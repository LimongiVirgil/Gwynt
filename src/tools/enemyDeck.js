...
export function getRandomEnemyDeck() {
  ...
  if (random === 0) {
    return {"card": enemyNordling.card, "faction": enemyNordling.faction}
  } else if (random === 1) {
    return {"card": enemyMonstre.card, "faction": enemyMonstre.faction}
  } else if (random === 2) {
    return {"card": enemyNilfgaard.card, "faction": enemyNilfgaard.faction}
  } else if (random === 3) {
    return {"card": enemySkelige.card, "faction": enemySkelige.faction}
  } else {
    return {"card": enemyScoiatael.card, "faction": enemyScoiatael.faction}
  }
}